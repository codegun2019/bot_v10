...
return [
    ...
    'images_upload.delete_confirm' => 'Are you sure you want to delete this image? This action cannot be undone.',
    ...
    'images_upload.copy_all_embeds' => 'Copy all embeds',
    'images_upload.embed_preset' => 'Embed preset',
    'images_upload.embed_preset_original' => 'Original image',
    'images_upload.embed_preset_thumb' => 'Thumbnail image',
    ...
    'global.menu.about_us' => 'About Us',
    'global.menu.features' => 'Features',
    ...
    'global.footer.description' => 'Your trusted partner for professional solutions. We create lasting relationships through honest advice and premium service.',
    'global.footer.quick_links' => 'Quick Links',
    'global.footer.services' => 'Services',
    'global.footer.company' => 'Company',
    'global.footer.rights_reserved' => 'All rights reserved.',
    ...
    'global.plan_settings.bot_cloaking_is_enabled' => 'Bot Detection & Content Cloaking',
    'global.plan_settings.bot_cloaking_is_enabled_help' => 'Enables Bot Detection and Content Cloaking features. Users can set different content for bots vs humans, configure cloaking meta tags, and view bot statistics.',
    ...
    'index.hero.title' => 'Track, Plan & <span class="vuto-text-grow-g">G</span><span class="vuto-text-grow-rest">row</span> Your Money<br>with Confidence',
    'index.hero.store.app_store.label' => 'Download on the',
    'index.hero.store.app_store.name' => 'App Store',
    'index.hero.store.google_play.label' => 'Get it on',
    'index.hero.store.google_play.name' => 'Google Play',
    'index.hero.pill.budget_goals' => 'Budget Goals',
    'index.hero.pill.expense_graphs' => 'Expense Graphs',
    'index.hero.pill.smart_alerts' => 'Smart Alerts',
    'index.hero.pill.bank_security' => 'Bank-Level Security',
    'index.hero.alt.app_dashboard' => 'App Dashboard',

    'index.partners.header' => 'Trusted by Our Clients',
    ...
    'index.services_badge' => 'Services',
    'index.services_badge_subheader' => 'Using technology to make finance simpler, smarter, and more rewarding.',
    'index.services.alt.app_interface' => 'App Interface',

    'index.additional_features.badge' => 'Our Feature',
    'index.additional_features.header' => 'Additional Features',
    'index.additional_features.subheader' => 'Complete tools for managing links and content',
    'index.additional_features.file_links.title' => 'File Links',
    'index.additional_features.file_links.title_en' => '(File links)',
    'index.additional_features.file_links.description' => 'Create customizable file download links',
    'index.additional_features.vcard_links.title' => 'Vcard Links',
    'index.additional_features.vcard_links.title_en' => '(Vcard links)',
    'index.additional_features.vcard_links.description' => 'Create trackable digital contact cards',
    'index.additional_features.event_links.title' => 'Event Links',
    'index.additional_features.event_links.title_en' => '(Event links)',
    'index.additional_features.event_links.description' => 'Create downloadable and trackable calendar files',
    'index.additional_features.splash_pages.title' => 'Splash Pages',
    'index.additional_features.splash_pages.title_en' => '(Splash pages)',
    'index.additional_features.splash_pages.description' => 'Customizable with countdown for your links',
    'index.additional_features.custom_domains.title' => 'Custom Domains',
    'index.additional_features.custom_domains.title_en' => '(Custom domains)',
    'index.additional_features.custom_domains.description' => 'Connect your own domain or use our provided domain',
    'index.additional_features.projects.title' => 'Projects',
    'index.additional_features.projects.title_en' => '(Projects)',
    'index.additional_features.projects.description' => 'Easily organize and manage your resources',
    'index.additional_features.auto_app_links.title' => 'Auto-opening App Links',
    'index.additional_features.auto_app_links.title_en' => '(Auto-opening app links)',
    'index.additional_features.auto_app_links.description' => 'Links that detect the app being used and automatically open on mobile',
    'index.additional_features.settings.title' => 'Settings',
    'index.additional_features.settings.title_en' => '(Settings)',
    'index.additional_features.settings.description' => 'Comprehensive management and customization of various settings',

    'index.pixels.badge' => 'Our Partners',

    'index.statistics.badge' => 'Statistics',
    'index.statistics.header' => 'Usage Statistics',
    'index.statistics.description' => 'We have a link tracking and analytics system that helps you understand visitor behavior',
    'index.statistics.try_button' => 'Try It Now',
    'index.statistics.alt.main_image' => 'Link Shortener | Sales Page | Bio | Analytics | MSSQ.ME',
    'index.statistics.feedback.analytical_thinking' => 'Analytical Thinking',
    'index.statistics.feedback.statistics_feedback' => 'Statistics Feedback',
    'index.statistics.feedback.reviews' => '(15k Reviews)',

    'index.testimonials.badge' => 'Testimonials',

    'index.faq.badge' => 'FAQ',
    'index.faq.header_fallback' => 'Frequently Asked Questions',

    'index.cta.alt.transfer_screen' => 'Transfer Screen',
    'index.cta.alt.dashboard_screen' => 'Dashboard Screen',
    'index.cta.alt.trusted_banking_screen' => 'Trusted Banking Screen',

    'index.jsonld.contact_type' => 'Contact us',
    ...
    'index.events.header' => 'Event links',
    'index.events.subheader' => 'Dynamically create downloadable & tracked calendar files.',
    ...
    'index.splash_page.header' => 'Splash pages',
    'index.splash_page.subheader' => 'Use custom made intermediary pages with countdowns for your links.',
    ...
    'index.pricing.subheader' => 'Select from best plans, ensuring a perfect match.',
    ...
    'index.testimonials.four.text' => 'This platform has significantly accelerated our business growth. Everything is integrated in one place, eliminating the need to switch between multiple systems.',
    'index.testimonials.four.name' => 'Sophia Lee',
    'index.testimonials.four.attribute' => 'Growth Manager, NeoCommerce',
    'index.testimonials.five.text' => 'As a startup, we needed a tool that\'s fast, flexible, and cost-effective. This platform checks all three boxes perfectly.',
    'index.testimonials.five.name' => 'Daniel Roberts',
    'index.testimonials.five.attribute' => 'Co-Founder, LaunchLab',
    'index.testimonials.six.text' => 'Managing clients and campaigns has become so much easier. The dashboard is clear, and our team sees all the data in real-time.',
    'index.testimonials.six.name' => 'Emily Carter',
    'index.testimonials.six.attribute' => 'Marketing Lead, Digital Spark',
    'index.testimonials.seven.text' => 'The system is highly stable and runs continuously without interruptions. Perfect for online businesses that need speed and accuracy.',
    'index.testimonials.seven.name' => 'Michael Nguyen',
    'index.testimonials.seven.attribute' => 'CTO, CloudNova',
    'index.testimonials.eight.text' => 'What I love most is the flexibility. We can adapt the system to our business model without writing additional code.',
    'index.testimonials.eight.name' => 'Olivia Martinez',
    'index.testimonials.eight.attribute' => 'Product Owner, Flexify',
    'index.testimonials.nine.text' => 'After using this platform, our team has eliminated many unnecessary steps. We can now focus fully on business growth.',
    'index.testimonials.nine.name' => 'Ryan Thompson',
    'index.testimonials.nine.attribute' => 'Operations Manager, ScaleUp Co.',
    'index.testimonials.ten.text' => 'This is truly a tool designed for modern businesses. It\'s fast, smart, and ready to scale with us in the long term.',
    ...
    'index.faq.six.question' => 'How does the premium plan differ from the free plan?',
    'index.faq.six.answer' => 'The premium plan unlocks advanced features such as unlimited usage, detailed Analytics, custom domain connection, and business growth tools.',
    'index.faq.seven.question' => 'Can I use a Custom Domain?',
    'index.faq.seven.answer' => 'Yes, premium and enterprise plans support custom domain connection to enhance brand credibility and image.',
    'index.faq.eight.question' => 'What data does the Analytics system provide?',
    'index.faq.eight.answer' => 'You can view detailed click data including country, device, browser, referrer, and user behavior to analyze and refine your strategy more accurately.',
    'index.faq.nine.question' => 'Do you support API for developers?',
    'index.faq.nine.answer' => 'Yes, we provide REST API for developers who want to integrate the system, create and manage links, or retrieve Analytics data for further use.',
    'index.faq.ten.question' => 'How can I contact the support team if I have issues?',
    'index.faq.ten.answer' => 'You can contact our support team via email or chat anytime. Our team is ready to help resolve issues and provide guidance quickly.',
    'index.faq.subheader' => 'Find answers to frequently asked questions',
    ...
    'link.settings.bot_cloaking_header' => 'Bot Detection & Content Cloaking',
    'link.settings.bot_cloaking_is_enabled' => 'Enable Bot Cloaking',
    'link.settings.bot_cloaking_is_enabled_help' => 'Enable Bot Detection and Content Cloaking features to show different content for bots vs humans',
    ...
    'link.settings.cloaking_opengraph_alt' => 'Open Graph Image Alt Text (og:image:alt)',
    'link.settings.cloaking_opengraph_alt_placeholder' => 'Image description for Open Graph (og:image:alt)',
    'link.settings.desktop_cloaking_is_enabled' => 'Desktop Cloaking (Human Desktop 302)',
    'link.settings.desktop_cloaking_is_enabled_help' => 'Works only for Human Desktop visitors, does not affect bot preview',
    'link.settings.desktop_cloaking_redirect_url' => 'Redirect URL (Fake Page)',
    'link.settings.desktop_cloaking_redirect_url_help' => 'URL to redirect Desktop visitors (must be a path starting with / or https:// same domain)',
    ...
    'link.biolink.blocks.line_liff' => 'LINE LIFF Share (Beta)',

    'biolink_line_liff.header' => 'LINE LIFF Share (Beta)',
    'biolink_line_liff.subheader' => 'Create a LIFF share button with Flex carousel cards.',

    'biolink_line_liff.liff_id' => 'LIFF ID',
    'biolink_line_liff.after_share_url' => 'After share URL',
    'biolink_line_liff.share_more_url' => 'Share more URL',
    'biolink_line_liff.links_signup' => 'Signup URL',
    'biolink_line_liff.links_line' => 'LINE URL',
    'biolink_line_liff.share_alt_text' => 'Alt text',

    'biolink_line_liff.items' => 'Cards',
    'biolink_line_liff.image_url' => 'Image URL',
    'biolink_line_liff.card_title' => 'Card title',
    'biolink_line_liff.card_desc' => 'Card description',
    'biolink_line_liff.card_btn' => 'Button label',
    'biolink_line_liff.card_url_key' => 'Link target',

    'biolink_line_liff.url_key.signup' => 'Signup URL',
    'biolink_line_liff.url_key.line' => 'LINE URL',

    'biolink_line_liff.add_item' => 'Add card',
    'biolink_line_liff.remove_item' => 'Remove card',

    'biolink_line_liff.liff_id_help' => 'Enter LIFF ID only (example: 2006611520-XXXXXXXX).',
    'biolink_line_liff.auto_url_help' => 'This URL is auto-generated from the LIFF ID and cannot be edited.',
    'biolink_line_liff.share_button_color' => 'Share button color',
    'biolink_line_liff.card_button_color' => 'Card button color',
