            ...
            if(!Alerts::has_field_errors() && !Alerts::has_errors()) {
                ...
                switch($_POST['type']) {
                    case 'email':
                        ...
                        if(settings()->users->email_confirmation && ($_POST['email'] != $notification_handler->settings->email || !$notification_handler->settings->email_is_confirmed)) {
                ...
                if(isset($_POST['test']) && (session_get('notification_handler_test_' . $_POST['type']) ?? 0) < 10) {
                    ...
                    switch($_POST['type']) {
                        case 'email':
                            ...
                            if($notification_handler->settings->email_is_confirmed) {
                                /* Prepare the email */
