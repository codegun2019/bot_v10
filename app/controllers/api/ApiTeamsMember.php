...
class ApiTeamsMember extends Controller {
    ...
    private function get() {
        ...
        $team_member = db()->where('team_member_id', $team_member_id)->where('user_id', $this->user->user_id)->getOne('teams_members');
    ...
    private function patch() {
        ...
        if($team_member && $team_member->user_id != $this->user->user_id && $team_member->user_email != $this->user->email) {
            $this->return_404();
        }
