...
class ApiPixels extends Controller {
    ...
    private function get() {
        ...
        $pixel = db()->where('pixel_id', $pixel_id)->where('user_id', $this->user->user_id)->getOne('pixels');
    ...
    private function post() {
        ...
        $total_rows = db()->where('user_id', $this->user->user_id)->getValue('pixels', 'count(`pixel_id`)');
    ...
    private function patch() {
        ...
        /* Check for the plan limit */
        $total_rows = db()->where('user_id', $this->user->user_id)->getValue('pixels', 'count(`project_id`)');
