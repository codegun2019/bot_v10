...
class ApiProjects extends Controller {
    ...
    private function get() {
        ...
        $project = db()->where('project_id', $project_id)->where('user_id', $this->user->user_id)->getOne('projects');
    ...
    private function post() {
        ...
        $total_rows = db()->where('user_id', $this->user->user_id)->getValue('projects', 'count(`project_id`)');
