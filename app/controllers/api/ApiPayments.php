...
class ApiPayments extends Controller {
    ...
    private function get_all() {
        ...
        while($row = $data_result->fetch_object()) {
            ...
            $row = [
                ...
                'payment_proof_url' => $row->payment_proof ? url('view/payment-proof/') . $row->payment_proof_url : null,
    ...
    private function get() {
        ...
        $payment = db()->where('id', $id)->where('user_id', $this->user->user_id)->getOne('payments');
        ...
        $data = [
            ...
            'payment_proof_url' => $payment->payment_proof ? url('view/payment-proof/') . $payment->payment_proof_url : null,
