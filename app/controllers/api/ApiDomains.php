...
class ApiDomains extends Controller {
    ...
    private function get() {
        ...
        $domain = db()->where('domain_id', $domain_id)->where('user_id', $this->user->user_id)->getOne('domains');
    ...
    private function patch() {
        ...
        /* Check for the plan limit */
        $total_rows = db()->where('user_id', $this->user->user_id)->getValue('domains', 'count(`domain_id`)');
