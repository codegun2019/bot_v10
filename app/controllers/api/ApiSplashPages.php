...
class ApiSplashPages extends Controller {
    ...
    private function get() {
        ...
        $splash_page = db()->where('splash_page_id', $splash_page_id)->where('user_id', $this->user->user_id)->getOne('splash_pages');
    ...
    private function post() {
        ...
        $total_rows = db()->where('user_id', $this->user->user_id)->getValue('splash_pages', 'count(`splash_page_id`)');
