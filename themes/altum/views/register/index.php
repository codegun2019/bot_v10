...
<form action="" method="post" class="mt-4" role="form">
    <?php if(!settings()->users->register_only_social_logins): ?>
        ...
        <div class="form-group" data-password-toggle-view data-password-toggle-view-show="<?= l('global.show') ?>" data-password-toggle-view-hide="<?= l('global.hide') ?>">
            ...
            <input id="password" type="password" name="password" maxlength="64" class="form-control <?= \Altum\Alerts::has_field_errors('password') ? 'is-invalid' : null ?>" value="<?= $data->values['password'] ?>" required="required" />
